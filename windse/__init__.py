...
def initialize(loc,updated_parameters=[]):
    ...
    global GridWindFarm, TrapWindFarm, RandomWindFarm, ImportedWindFarm, EmptyWindFarm
    from windse.wind_farm_types import GridWindFarm, TrapWindFarm, RandomWindFarm, ImportedWindFarm, EmptyWindFarm
